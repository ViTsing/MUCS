...
'''
python cherry_selection/data_by_cluster.py \
...
def parse_args():
    ...
    parser.add_argument("--pt_data_path", type=str, required=True)   # 存储了句子 embedding 和 ppl 值的 .pt 文件
    ...
    parser.add_argument("--sample_num", type=int, default=10)   # 每个簇采样的样本数
    parser.add_argument("--kmeans_num_clusters", type=int, default=100)   # k-means 聚类簇数
